            ...
            {filtered.map(product => (
              <article key={product.id} className="product-card group">
                ...
                <a 
                  ...
                  className="relative block aspect-[4/5] overflow-hidden bg-neutral-100 mb-4 cursor-pointer"
                >
                  <img
                    src={product.image}
                    alt={product.name}
                    ...
                    loading="lazy"
                    style={{ viewTransitionName: `img-${product.id}` } as any}
                  />
                  {/* Overlay */}
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <a href={`/productos/${product.id}`} className="hover:opacity-70 transition-opacity">
